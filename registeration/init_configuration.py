...
class config(bpy.types.PropertyGroup):
    ...
    resX: bpy.props.IntProperty(name = "resX", default= 640)
    resY: bpy.props.IntProperty(name = "resY", default= 480)
    fx: bpy.props.FloatProperty(name="fx", description="camera intrinsic fx.", 
        min=0.00, max=1500.00, step=10, precision=2, default= 601.17364502)    
    fy: bpy.props.FloatProperty(name="fy", description="camera intrinsic fy.", 
        min=0.00, max=1500.00, step=10, precision=2, default= 600.0300293)   
    cx: bpy.props.FloatProperty(name="cx", description="camera intrinsic cx.", 
        min=0.00, max=1000.00, step=10, precision=2, default= 332.08534315)    
    cy: bpy.props.FloatProperty(name="cy", description="camera intrinsic cy.", 
        min=0.00, max=1000.00, step=10, precision=2, default= 243.56048719)
